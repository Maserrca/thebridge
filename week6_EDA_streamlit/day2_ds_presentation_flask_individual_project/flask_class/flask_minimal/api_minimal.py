...
app = Flask(__name__) ##La instancia de la clase flask
...
@app.route("/") #La que se va a llamar por defecto cuando pongamos la diección de la api
def home():
...
def upload_form(): #No tiene por que tener el mismo nombre 
...
if __name__ == '__main__':
    ...
    # host='0.0.0.0' --> Permite recibir llamadas desde el exterior, si no pponemos eso no podra ser publico
